...
typedef SingleChildAutocompleteOptionsViewBuilder<T extends Object> = Widget Function(
...
class RawAutocompleteModifier<T extends Object> extends SingleChildStatelessModifier {
  ...
  Widget buildWithChild(BuildContext context, Widget? child) {
    return RawAutocomplete<T>(
      key: modifierKey,
      optionsViewBuilder: (context, onSelected, options) => optionsViewBuilder(context, onSelected, options, child),
