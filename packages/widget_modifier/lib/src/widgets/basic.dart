...
class SizedBoxModifier extends SingleChildStatelessModifier {
  ...
  SizedBoxModifier.fromSize({Key? key, Widget? child, super.modifierKey, Size? size})
      : width = size?.width,
        height = size?.height,
        super(key: key, child: child);

  const SizedBoxModifier.square({Key? key, Widget? child, super.modifierKey, double? dimension})
      : width = dimension,
        height = dimension,
        super(key: key, child: child);
...
class MergeSemanticsModifier extends SingleChildStatelessModifier {
  const MergeSemanticsModifier({Key? key, Widget? child, super.modifierKey}) : super(key: key, child: child);
...
class BlockSemanticsModifier extends SingleChildStatelessModifier {
  const BlockSemanticsModifier({Key? key, super.modifierKey, this.blocking = true, Widget? child})
      : super(key: key, child: child);
...
class ColoredBoxModifier extends SingleChildStatelessModifier {
  const ColoredBoxModifier({required this.color, super.modifierKey, Widget? child, Key? key})
      : super(key: key, child: child);
