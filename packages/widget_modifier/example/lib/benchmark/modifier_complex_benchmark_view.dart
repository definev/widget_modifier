...
class ModifierComplexBenchmarkView extends StatefulWidget {
  ...
  @override
  State<ModifierComplexBenchmarkView> createState() => _ModifierComplexBenchmarkViewState();
}

class _ModifierComplexBenchmarkViewState extends State<ModifierComplexBenchmarkView> {
  final _children = [
